...
const ExerciseProgram = () => {
  ...
  const saveProgram = async () => {
    ...
    try {
      ...
      alert("Saved Program succesfully");
    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between">
          <CardTitle className="">
            <div className="p-2">Exercise Programme</div>
            ...
            <DragDropContext onDragEnd={handleDragEnd}>
              <Droppable droppableId="exercises">
                {(provided) => (
                  ...
                  >
                    {exercises.length === 0 ? (
                      // Render this message when there are no exercises
                      <div className="flex items-center justify-center h-full text-xl py-24 text-black font-mono">
                        Add exercises from above to get started!
                      </div>
                    ) : (
                                  ...
                                  <div>
                                    ...
                                    <div className="flex items-center ">
                                      ...
                                      <DropdownMenu>
                                        ...
                                        <DropdownMenuContent>
                                          {Object.keys(equipmentIcons).map(
                                            (key) => (
                                              <DropdownMenuItem
                                                key={key}
                                                onClick={() =>
