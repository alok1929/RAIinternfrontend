  ...
  const fetchCategoryExercises = async (categoryId: string) => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/categories/${categoryId}/exercises`,
      );
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Input
              value={exercise.name}
              onChange={(e) =>
                updateExerciseValue(index, "name", e.target.value)
              }
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4 space-y-3">
            ...
            <div key={field}>
              ...
              <div className="flex items-center">
                ...
                <Button
                  ...
                  size="icon"
                  onClick={() =>
                    updateExerciseValue(index, field, exercise[field] + 1)
                  }
                >
          ...
          <div>
            ...
            <div className="flex items-center">
              ...
              <Button
                ...
                size="icon"
                onClick={() =>
                  updateExerciseValue(index, "weight", exercise.weight + 1)
                }
              >
                <Plus className="h-4 w-4" />
              </Button>
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" size="icon" className="ml-2">
                    {React.createElement(equipmentIcons[exercise.equipment], {
                      className: "h-4 w-4",
                    })}
                  </Button>
                </DropdownMenuTrigger>
                <DropdownMenuContent>
                  {(Object.keys(equipmentIcons) as Equipment[]).map((key) => (
                    <DropdownMenuItem
                      key={key}
                      onClick={() =>
                        updateExerciseValue(index, "equipment", key)
                      }
                    >
                      {React.createElement(equipmentIcons[key], {
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(value) =>
                updateExerciseValue(index, "stage", value)
              }
            >
                            ...
                            <div className="flex-1 space-y-4">
                              <div className="flex items-center justify-between mb-4">
                                ...
                                <div className="flex space-x-2">
                                  ...
                                  <Button
                                    onClick={() =>
                                      duplicateExercise(exercise, index)
                                    }
                              ...
                              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                                {(["sets", "reps", "holdTime"] as const).map(
                                  (field) => (
                                    <div key={field}>
                                      <Label>
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center space-x-2">
              <Input
                ...
                value={breakInterval}
                onChange={(e) =>
                  setBreakInterval(parseInt(e.target.value) || 30)
                }
                className="w-20"
                min="0"
              />
